...
import io.awspring.cloud.v3.it.support.TestStackInstanceIdService;
...
public class IntegrationTestConfig {
	...
	@Bean
	public TestStackEnvironment testStackEnvironment(CloudFormationClient amazonCloudFormation) {
		return new TestStackEnvironment(amazonCloudFormation);
	}

	@Bean
	public TestStackInstanceIdService testStackInstanceIdService(CloudFormationClient amazonCloudFormation) {
