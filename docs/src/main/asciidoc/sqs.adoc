...
- `acknowledgementMode` - Set the acknowledgement mode for the container. Default value is `SqsListenerAcknowledgementMode.DEFAULT`,
meaning that it will use the acknowledgement mode defined for the container factory. See <<Acknowledgement Mode>> for more information.
