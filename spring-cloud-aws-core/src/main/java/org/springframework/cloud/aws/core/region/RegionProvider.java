 ...
 * interfaces might be simple static region configuration which is feasible for single location applications, or
 * dynamic regions which can fetched from the execution environment where the application is currently running.
 *
 * @author Agim Emruli
 * @since 1.0
 */
