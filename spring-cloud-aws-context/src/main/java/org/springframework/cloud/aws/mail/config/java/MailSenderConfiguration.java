...
package org.springframework.cloud.aws.mail.config.java;
...
public class MailSenderConfiguration {
	...
	@Bean
	@ConditionalOnMissingBean(name = "amazonSimpleEmailService")
	...
	@Bean
	@ConditionalOnMissingClass(SimpleEmailServiceJavaMailSender.class)
