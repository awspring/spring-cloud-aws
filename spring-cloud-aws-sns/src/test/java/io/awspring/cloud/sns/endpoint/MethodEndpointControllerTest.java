...
class MethodEndpointControllerTest {
	...
	@Autowired
	private MethodNotificationTestController notificationTestController;
	...
	@EnableWebMvc
	@Import(MethodNotificationTestController.class)
	static class Config {
	...
	@Controller
	static class MethodNotificationTestController {
