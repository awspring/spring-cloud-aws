...
public class AmazonEC2PropertyPlaceHolderAwsTest {
	...
	public void testGetUserProperties() throws Exception {
		...
		AmazonEC2UserDataPropertySource amazonEC2PropertySource = new AmazonEC2UserDataPropertySource("test", new AmazonEC2Client(new SystemPropertiesCredentialsProvider()));
