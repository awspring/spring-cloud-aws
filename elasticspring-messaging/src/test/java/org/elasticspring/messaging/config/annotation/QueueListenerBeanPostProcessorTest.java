...
public class QueueListenerBeanPostProcessorTest {
	...
	public void testRegisterContainerWithMinimalConfiguration() throws Exception {
		...
		RuntimeBeanReference messageListenerTarget = (RuntimeBeanReference) messageListener.getConstructorArgumentValues().getArgumentValue(1, MinimalListenerConfiguration.class).getValue();
	...
	public void testWithCustomConfiguration() throws Exception {
		...
		RuntimeBeanReference messageListenerTarget = (RuntimeBeanReference) messageListenerConstructorArgumentValues.getArgumentValue(1, MinimalListenerConfiguration.class).getValue();
		Assert.assertEquals("queueListenerBean", messageListenerTarget.getBeanName());
	...
	static class InvalidBeanWithNoDestination {
		...
		@QueueListener
		public void methodWithNoDestination() {
	...
	static class InvalidBeanWithAmbiguousDestinations {
		...
		public void methodWithAmbiguousDestinations() {
