...
public class CloudMapServiceInstance implements ServiceInstance {
	...
	public String getInstanceId() {
		return instanceSummary.instanceId();
	}
	...
	public String getServiceId() {
		return UTILS.generateServiceId(instanceSummary.namespaceName(), instanceSummary.serviceName());
	}

	@Override
	public String getHost() {
		return instanceSummary.attributes().get("AWS_INSTANCE_IPV4");
	}

	@Override
	public int getPort() {
		String port = instanceSummary.attributes().get("AWS_INSTANCE_PORT");
	...
	public Map<String, String> getMetadata() {
		return instanceSummary.attributes();
	}
