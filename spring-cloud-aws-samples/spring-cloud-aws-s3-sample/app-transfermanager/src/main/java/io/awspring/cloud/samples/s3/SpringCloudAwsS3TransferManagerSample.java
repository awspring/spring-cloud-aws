...
public class SpringCloudAwsS3TransferManagerSample {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(SpringCloudAwsS3TransferManagerSample.class);

	public static void main(String[] args) {
		SpringApplication.run(SpringCloudAwsS3TransferManagerSample.class, args);
	}
	...
	ApplicationRunner applicationRunner(S3Client s3Client, ResourceLoader resourceLoader) {
		return args -> {
			...
			// write to resource (uses the TransferManagerS3OutputStream under the hood)
