...
/**
 * Annotation that enables caching based on the ElastiCache caching service. This annotation is
 * a meta-annotation of {@link org.springframework.cache.annotation.EnableCaching} with the same
 * configuration attributes. In contrast to the {@link org.springframework.cache.annotation.EnableCaching}
 * annotation this annotation does not require a {@link org.springframework.cache.annotation.CachingConfigurer}
...
public @interface EnableElastiCache {
	...
	/**
	 * Configures the cache cluster names for the caching configuration. Support one or multiple caches
	 * names with their physical cache name (as configured in the ElastiCache service) or their logical
