...
public class ApplicationService {
 ...
 public void handleApplicationLogic() {
 	String physicalBucketName = this.resourceIdResolver.resolveToPhysicalResourceId("someLogicalName");
 }
}
----
...
----
<beans ..>
<jdbc:retry-interceptor db-instance-identifier="myRdsDatabase"
							id="myInterceptor"  max-number-of-retries="10" />
</beans>
----
