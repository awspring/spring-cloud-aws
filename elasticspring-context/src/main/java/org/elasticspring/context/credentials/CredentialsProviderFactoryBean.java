...
/**
 * {@link org.springframework.beans.factory.FactoryBean} that creates a composite {@link AWSCredentialsProvider} based
 * on the delegates.
 *
 * @author Agim Emruli
 * @since 1.0
...
public class CredentialsProviderFactoryBean extends AbstractFactoryBean<AWSCredentialsProvider> {
	...
	protected AWSCredentialsProvider createInstance() throws Exception {
		return new AWSCredentialsProviderChain(this.delegates.toArray(new AWSCredentialsProvider[this.delegates.size()]));
	}
}