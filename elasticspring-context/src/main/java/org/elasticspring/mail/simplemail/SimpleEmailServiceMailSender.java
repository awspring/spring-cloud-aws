...
public class SimpleEmailServiceMailSender implements MailSender, DisposableBean {
	...
	public SimpleEmailServiceMailSender(String accessKey, String secretKey) {
		this.emailService = new AmazonSimpleEmailServiceClient(new BasicAWSCredentials(accessKey, secretKey));
	}
