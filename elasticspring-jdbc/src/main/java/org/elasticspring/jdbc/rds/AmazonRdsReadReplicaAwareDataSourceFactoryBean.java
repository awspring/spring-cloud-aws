...
/**
 * {@link org.elasticspring.jdbc.rds.AmazonRdsDataSourceFactoryBean} sub-class that is capable to handle amazon rds
...
public class AmazonRdsReadReplicaAwareDataSourceFactoryBean extends AmazonRdsDataSourceFactoryBean {
	...
	/**
	 * Constructs a {@link org.elasticspring.jdbc.datasource.ReadOnlyRoutingDataSource} data source that contains the
	 * regular data source as a default, and all read-replicas as additional data source. The {@link
	 * org.elasticspring.jdbc.datasource.ReadOnlyRoutingDataSource} is additionally wrapped with a {@link
