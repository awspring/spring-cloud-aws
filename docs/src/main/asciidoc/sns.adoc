...
HTTP endpoints are based on Spring MVC controllers. Spring Cloud AWS provides custom argument resolvers to extract the message and subject from notification requests.
