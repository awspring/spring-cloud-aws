...
----
 <beans ...>
     <aws-context:context-credentials>
       <aws-context:simple-credentials access-key="AKIAIOSFODNN7EXAMPLE" secret-key="wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY" />
     </aws-context:context-credentials>
 </beans>
----
...
==== Using instance tags
User configured properties can also be configured with tags instead of user data. Tags are global in the context
 of Amazon Webservices and used for different services. Spring Cloud AWS support instance tags also across different
...
The instance tags can then be accessed like the user data using the _@Value_ annotation or the
_${}_ placeholder seen in the examples above.
