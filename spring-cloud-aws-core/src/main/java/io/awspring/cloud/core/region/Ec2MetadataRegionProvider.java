...
/**
 * {@link RegionProvider} implementation that dynamically retrieves the region with the
 * EC2 meta-data. This implementation allows application to run against their region
