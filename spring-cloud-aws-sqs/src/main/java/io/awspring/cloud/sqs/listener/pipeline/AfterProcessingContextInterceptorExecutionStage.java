 ...
 * @since 3.0
 */
public class AfterProcessingContextInterceptorExecutionStage<T>
	...
	@Override
	protected Collection<AsyncMessageInterceptor<T>> getMessageInterceptors(MessageProcessingContext<T> context) {
