...
public class QueueMessagingTemplate extends AbstractMessageChannelMessagingSendingTemplate<QueueMessageChannel>
	...
	public QueueMessagingTemplate(SqsClient amazonSqs, ResourceIdResolver resourceIdResolver) {
	 ...
	 * composite converter.
	 */
	public QueueMessagingTemplate(SqsClient amazonSqs, DestinationResolver<String> destinationResolver,
			MessageConverter messageConverter) {
