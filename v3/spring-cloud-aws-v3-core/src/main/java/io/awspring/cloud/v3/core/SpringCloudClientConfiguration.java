...
/**
 * Provides configuration related overrides that may be applied across various AWS service
 * integrations.
 *
...
public final class SpringCloudClientConfiguration {
	...
	/**
	 * Returns desired client config overrides.
	 * @return the client configuration overrides.
	 */
