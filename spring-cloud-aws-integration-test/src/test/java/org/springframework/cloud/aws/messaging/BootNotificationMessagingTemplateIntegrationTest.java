 ...
 * @author Alain Sahli
 */
@SpringApplicationConfiguration(classes = BootNotificationMessagingTemplateIntegrationTest.NotificationMessagingTemplateIntegrationTestConfiguration.class)
@IntegrationTest
