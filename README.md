...
|------------------------|--------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|
| Spring Cloud AWS 4.1.1 | [Reference Docs](https://docs.awspring.io/spring-cloud-aws/docs/4.1.1/reference/html/index.html) | [API Docs](https://docs.awspring.io/spring-cloud-aws/docs/4.1.1/apidocs/index.html) | 
| Spring Cloud AWS 4.1.0 | [Reference Docs](https://docs.awspring.io/spring-cloud-aws/docs/4.1.0/reference/html/index.html) | [API Docs](https://docs.awspring.io/spring-cloud-aws/docs/4.1.0/apidocs/index.html) | 
...
| 4.x.x                       | [2025.1.x](https://github.com/spring-cloud/spring-cloud-release/wiki/Spring-Cloud-2025.0-Release-Notes)               | 4.0.x        | 7.0.x            | 2.x          |
...
| AWS Service                            | Spring Cloud AWS 2.x | Spring Cloud AWS 3.x                                                                                                                        | Spring Cloud AWS 4.0.x | Spring Cloud AWS 4.1.x |
|----------------------------------------|----------------------|---------------------------------------------------------------------------------------------------------------------------------------------|------------------------|------------------------|
| S3                                     | ✅                    | ✅                                                                                                                                           | ✅                      | ✅                      |
| SNS                                    | ✅                    | ✅                                                                                                                                           | ✅                      | ✅                      |
| SES                                    | ✅                    | ✅                                                                                                                                           | ✅                      | ✅                      |
...
| CloudFormation                         | ✅                    | ❌                                                                                                                                           | ❌                      | ❌                      |
| CloudWatch                             | ✅                    | ✅                                                                                                                                           | ✅                      | ✅                      |
| Cognito                                | ✅                    | [Covered by Spring Boot](https://docs.awspring.io/spring-cloud-aws/docs/3.0.0-SNAPSHOT/reference/html/index.html#migration-from-2-x-to-3-x) | Covered by Spring Boot | Covered by Spring Boot |
| DynamoDB                               | ❌                    | ✅                                                                                                                                           | ✅                      | ✅                      |
