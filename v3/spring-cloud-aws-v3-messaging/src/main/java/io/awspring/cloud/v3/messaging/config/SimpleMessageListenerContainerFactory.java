...
public class SimpleMessageListenerContainerFactory {
	...
	/**
	 * Sets the {@link SqsClient} that is going to be used by the container to
	 ...
	 * {@link io.awspring.cloud.v3.messaging.support.destination.DynamicQueueUrlDestinationResolver}
