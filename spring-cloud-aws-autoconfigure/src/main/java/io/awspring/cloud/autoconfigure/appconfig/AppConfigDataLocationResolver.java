 ...
 * @since 2.4
 */
public class AppConfigDataLocationResolver implements ConfigDataLocationResolver<AppConfigDataResource> {
	...
	@Override
	public List<AppConfigDataResource> resolveProfileSpecific(ConfigDataLocationResolverContext context,
