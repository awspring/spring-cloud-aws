...
/**
 * Support interface used by the {@link org.springframework.cloud.aws.jdbc.datasource.DataSourceFactory} implementation to retrieve
...
public interface DatabasePlatformSupport {
	...
	/**
	 * Returns the fully qualified driver class name for the database platform. Implementation may return one static
	 * driver class name or check for the existence of different driver class on the class path and return the best
	 * matching one.
	 *
	 * @param databaseType
	 * 		- The database type for which the database driver class should be returned.
	...
	/**
	 * Constructs the database URL for the database instance. Implementation will typically infer the URI scheme from the
	 ...
	 * @return - A fully constructed and valid url for the datasource to connect to the database platform.
	 */
